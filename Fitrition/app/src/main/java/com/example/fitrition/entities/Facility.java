...
public class Facility {
    ...
    public Facility(String facilityID, String name, String description, int postalCode, LocalDateTime openingHour, String contactNumber, String priceRange, String emailAddress, String password, String eateryAddress, int numberOfClicks, ArrayList<Integer> ratingScoreList, int numTotalRating, ArrayList<Review> reviewList) {
    }
