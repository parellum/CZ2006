...
public class Eatery extends Facility{
    ...
    public Eatery(int facilityID, String name,String description, int postalCode,
        ...
        super(facilityID, name, description, postalCode, openingHour, contactNumber,
                priceRange, emailAddres, password, eateryAddress, numberOfClicks,
    ...
    /**
     * Takes in the information like type of food, foodID and list of food
     * provided by user and updates the typeOfFood, foodID, listOfFood fields
     * @param typeOfFood
     * @param foodID
     * @param listOfFood
     */
